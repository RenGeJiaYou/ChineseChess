...
var SQUARE_LEFT = (BOARD_WIDTH - SQUARE_SIZE * 9) >> 1;   //整个棋子区域离棋盘.jpg边缘的左边距
var SQUARE_TOP = (BOARD_HEIGHT - SQUARE_SIZE * 10) >> 1;  //整个棋子区域离棋盘.jpg边缘的上边距
var THINKING_SIZE = 32;   //thinking.jpg的边长
var THINKING_LEFT = (BOARD_WIDTH - THINKING_SIZE) >> 1;   //thinking.jpg离棋盘.jpg的左边距
var THINKING_TOP = (BOARD_HEIGHT - THINKING_SIZE) >> 1;   //thinking.jpg离棋盘.jpg的上边距 
var MAX_STEP = 8;
